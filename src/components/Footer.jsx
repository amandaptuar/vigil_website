          ...
          <div className="row">
            <div className="col-xxl-4 col-xl-12">
              <div className="luminix-footer-textarea pr-50">
                <Link to="/">
                  <img src="/myimg/image.png" alt="" style={{ maxHeight: '60px' }} />
                </Link>
                <p>The most trusted parental monitoring system. Vigil gives parents real-time visibility into their child's digital world — so you can protect what matters most.</p>
